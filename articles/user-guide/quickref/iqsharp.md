...
- [`%who`](xref:microsoft.quantum.iqsharp.magic-ref.who): 현재 세션에서 사용할 수 있는 Q # 작업을 나열 합니다.
...
- [`%azure.target`](xref:microsoft.quantum.iqsharp.magic-ref.azure.target): Azure 퀀텀 작업 영역에서 Q # 작업 제출에 대 한 활성 실행 대상을 설정 하거나 표시 합니다.
...
- [`%chemistry.encode`](xref:microsoft.quantum.iqsharp.magic-ref.chemistry.encode): Fermion Hamiltonian를 Q #에서 사용할 수 있는 형식으로 인코딩합니다.
