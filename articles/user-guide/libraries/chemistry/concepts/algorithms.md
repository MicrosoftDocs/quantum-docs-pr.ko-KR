...
<span data-ttu-id="2162a-162">이러한 서브루틴은에서 쉽게 설정할 수 :::no-loc(Q#)::: 있습니다.</span><span class="sxs-lookup"><span data-stu-id="2162a-162">These subroutines are easy to set up in :::no-loc(Q#):::.</span></span>
