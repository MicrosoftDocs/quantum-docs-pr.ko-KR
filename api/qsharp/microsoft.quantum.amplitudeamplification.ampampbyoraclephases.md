...
---
# <a name="ampampbyoraclephases-function"></a>AmpAmpByOraclePhases 함수
...
> [!WARNING]
> AmpAmpByOraclePhases는 더 이상 사용 되지 않습니다. 대신 <xref:Microsoft.Quantum.AmplitudeAmplification.AmplitudeAmplificationFromStatePreparation>를 사용하십시오.
>
> @"microsoft.quantum.amplitudeamplification.amplitudeamplificationfromstatepreparation"을 사용하세요.
