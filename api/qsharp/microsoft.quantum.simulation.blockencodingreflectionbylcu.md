...
### <a name="statepreparation--qubit--unit-adj--ctl"></a>statePreparation: 고 [비트](xref:microsoft.quantum.lang-ref.qubit)[] => [Unit](xref:microsoft.quantum.lang-ref.unit) Adj + Ctl

일부 대상 상태를 준비 하는 단일 $P $입니다.


### <a name="selector--qubitqubit--unit-adj--ctl"></a>selector: (추가[비트](xref:microsoft.quantum.lang-ref.qubit)[[], [](xref:microsoft.quantum.lang-ref.qubit)]) => [Unit](xref:microsoft.quantum.lang-ref.unit) Adj + Ctl
