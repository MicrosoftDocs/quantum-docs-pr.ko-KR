...
### <a name="onequalop--unit--unit--is-ctl"></a>끄기: [단위](xref:microsoft.quantum.lang-ref.unit) => [단위가](xref:microsoft.quantum.lang-ref.unit)  Ctl입니다.




### <a name="onnonequalop--unit--unit--is-ctl"></a>onnonp: [단위](xref:microsoft.quantum.lang-ref.unit) => [단위가](xref:microsoft.quantum.lang-ref.unit)  Ctl입니다.
